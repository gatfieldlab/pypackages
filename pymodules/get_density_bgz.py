...
r"""Extract mapped read positions & lengths from indexed BGZF compressed files

The *density file* had to be compressed with bgzip utility and indexed with
tr_index_bgz.py before this script can work on

Modified on Sep 04 2015
...
def get_index_tr(density_file, tr_ids, ok_flags=OK_FLAGS):
    try:
        density_file_handle = bgzf.BgzfReader(density_file, 'r')
    except IOError as e:
